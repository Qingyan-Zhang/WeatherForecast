...
public class SQLHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        insertProvinceCity(db,"山西省",new String[]{"太原市","大同市","阳泉市","长治市","晋城市","朔州市","晋中市","运城市","忻州市","临汾市","吕梁市"});
        ...
        insertProvinceCity(db,"福建省",new String[]{"福州市","厦门市","莆田市","三明市","泉州市","漳州市","南平市","龙岩市","宁德市"});
        insertProvinceCity(db,"青海省",new String[]{"西宁市","海东市"});
        insertProvinceCity(db,"河北省",new String[]{"石家庄市","唐山市","秦皇岛市","邯郸市","邢台市","保定市","张家口市","承德市","沧州市","廊坊市","衡水市"});
        insertProvinceCity(db,"山东省",new String[]{"济南市","青岛市","淄博市","枣庄市","东营市","烟台市","潍坊市","济阳市","泰安市","威海市","日照市","莱芜市","临沂市","德州市","聊城市","滨州市","菏泽市"});
        insertProvinceCity(db,"河南省",new String[]{"郑州市","洛阳市","开封市","焦作市","新乡市","许昌市","漯河市","平顶山市","三门峡市","信阳市","周口市","驻马店市"});
        insertProvinceCity(db,"新疆维吾尔族自治区",new String[]{"乌鲁木齐市","克拉玛依市","吐鲁番地区","哈密地区","和田地区","喀什地区","阿克苏地区","克孜勒苏柯尔克孜自治州","巴音郭克孜自治州","昌吉回族自治州","博尔塔拉蒙古自治州","伊犁哈萨克自治州","塔城地区","阿勒泰地区"});
        insertProvinceCity(db,"浙江省",new String[]{"杭州市","宁波市","温州市","嘉兴市","湖州市","绍兴市","金华市","衢州市","舟山市","台州市","丽水市"});
        ...
        insertProvinceCity(db,"江苏省",new String[]{"南京市","无锡市","徐州市","常州市","苏州市","南通市","连云港市","淮安市","盐城市","扬州市","镇江市","泰州市","宿迁市"});
