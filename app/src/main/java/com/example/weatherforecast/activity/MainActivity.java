...
public class MainActivity extends AppCompatActivity {
    ...
    private final OkHttpClient okHttpClient = new OkHttpClient();   // okHttp
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Star：收藏的城市
        // 城市缓存
        SharedPreferences starShaPre = getSharedPreferences("StarCity", Context.MODE_PRIVATE);
    ...
    private void updateStarButton() {
        ...
        if (weatherList.contains(city)) {
            starButton.setText("取消关注");
        } else {
            starButton.setText("关注");
        }
    }
    ...
    private void init() {
        ...
        Button ref_btn = findViewById(R.id.ref_btn);
        swipeRefreshLayout = findViewById(R.id.swipe_refresh_layout);
        listview.setCacheColorHint(4); // 空间换时间
        swipeRefreshLayout.setOnRefreshListener(this::refreshDiaries);         // 下拉刷新监听器
